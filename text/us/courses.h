...
SECRET_STAR(COURSE_CAKE_END, _("   A DELICIOUS CAKE"))

CASTLE_SECRET_STARS(_("   CASTLE SECRET STARS"))

EXTRA_TEXT(0, _("One of the castle's secret stars!"))
EXTRA_TEXT(1, _("A secret star of 100 coins"))
EXTRA_TEXT(2, _("The MOUNTAIN'S HAZE opens!")) // FIXME
EXTRA_TEXT(3, _("WET-DRY WORLD rooms open!")) // FIXME
EXTRA_TEXT(4, _("The big STAR DOOR opens!")) // FIXME
EXTRA_TEXT(5, _("The door to BOWSER opens!"))
EXTRA_TEXT(6, _("The door to the 3rd gen. opens!")) // FIXME
